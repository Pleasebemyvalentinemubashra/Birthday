...
function BirthdayCake() {
  return (
    <svg className="w-full" viewBox="0 0 340 225" style={{ filter:'drop-shadow(0 12px 28px rgba(180,80,100,.25))' }}>
      ...
      <defs>
        <linearGradient id="ck1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#f5c8d8"/><stop offset="100%" stopColor="#e898b8"/></linearGradient>
        <radialGradient id="ck1t" cx="50%" cy="50%" r="50%"><stop offset="0%" stopColor="#fce4ef"/><stop offset="100%" stopColor="#f8c0d4"/></radialGradient>
        <linearGradient id="ck2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#f8d8e8"/><stop offset="100%" stopColor="#ecaac4"/></linearGradient>
        <radialGradient id="ck2t" cx="50%" cy="50%" r="50%"><stop offset="0%" stopColor="#fdeef5"/><stop offset="100%" stopColor="#f8cce0"/></radialGradient>
        <linearGradient id="ck3" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#fce8f0"/><stop offset="100%" stopColor="#f0b4c8"/></linearGradient>
        <radialGradient id="ck3t" cx="50%" cy="50%" r="50%"><stop offset="0%" stopColor="#fff0f6"/><stop offset="100%" stopColor="#fcd8e8"/></radialGradient>
      </defs>
    </svg>
  );
}
...
export function CakeCandleSection({ age }: CakeCandleSectionProps) {
  ...
  return (
    <section id="cake" className="min-h-screen flex flex-col items-center justify-center py-20 px-4 relative overflow-hidden"
      ...
      <motion.div className="text-center mb-8"
        ...
        <p className="text-sm tracking-[.2em] uppercase mb-2" style={{ fontFamily:'var(--font-serif)', color:ROSE }}>Make a Wish</p>
        <h2 className="text-5xl" style={{ fontFamily:'var(--font-handwritten)', color:ROSE }}>Happy {age}th!</h2>
      </motion.div>

      {/* Cake stage */}
      <div ref={cakeRef} className="relative" style={{ width:340, maxWidth:'90vw' }}>
        <AnimatePresence>
        ...
        <AnimatePresence>
          {showMsg && (
            <motion.p className="text-center mt-6 text-5xl"
